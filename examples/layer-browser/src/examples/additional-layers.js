...
const HEAT_LAYER_EQ_PROPS = {
  getData: () => dataSamples.earthquakes,
  props: {
    id: 'heatmp-layer-eq',
    opacity: 1,
    extruded: true,
...
const HeatMapLayerExampleEQ = Object.assign({}, {layer: HeatMapLayer}, HEAT_LAYER_EQ_PROPS);
...
export default {
  ...
  'Experimental Core Layers': {
    ...
    HeatMapLayerEQ: HeatMapLayerExampleEQ,
